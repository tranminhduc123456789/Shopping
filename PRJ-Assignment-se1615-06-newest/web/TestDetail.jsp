<%-- 
    Document   : TestDetail
    Created on : Mar 23, 2022, 11:50:53 PM
    Author     : duyta
--%>
...
<html>
    <head>
        ...
        <!-- Site Metas -->
        <title>Chickentique - Detail</title>
    ...
    <body>
        ...
        <div class="item active">
            <a href="#"> <img src="${detail.image}" alt="" style="width: 400px; margin-left: 40%; margin-top: 2%;"></a>
        </div>
        <div class="span7" style="margin-left: 40%; margin-top: 2%;">
            <h2><b>${detail.productName}</b></h2>
            <h5>Price: ${detail.price}$</h5>
            <h3>Description: ${detail.description}</h3>
             <a href="Shopping.jsp" 
                style="border: 1px solid red; padding: 10px; border-radius: 5px; background: red;">
                 Back To Home</a>
            <hr class="soft"/>
